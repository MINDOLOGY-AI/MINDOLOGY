...
random_words.jsonl      8,000   REMIX mixing data, from /usr/share/dict/words, no download
...
# fact schema (all files except random_words)
...
random_words.jsonl: `{"id": "rws_0", "text": "50 space separated words"}`
